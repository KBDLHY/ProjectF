...
UCLASS(Abstract)
class UReticleWidgetBase : public UCommonUserWidget
{
	GENERATED_BODY()

public:
	UReticleWidgetBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintImplementableEvent)
	void OnWeaponInitialized();

	UFUNCTION(BlueprintCallable)
	void InitializeFromWeapon(UWeaponInstance* InWeapon);
...
protected:
	...
	UPROPERTY(BlueprintReadOnly)
	TObjectPtr<UInventoryItemInstance> InventoryInstance;
};
