...
#include "Equipment/Ability_FromEquipment.h"

#include "Ability_RangedWeapon.generated.h"
...
/**
 * UAbility_RangedWeapon
 *
 * An ability granted by and associated with a ranged weapon instance
 */
UCLASS()
class UAbility_RangedWeapon : public UAbility_FromEquipment
{
	GENERATED_BODY()

public:

	UAbility_RangedWeapon(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category="|Ability")
	URangedWeaponInstance* GetWeaponInstance() const;
...
protected:
	struct FRangedWeaponFiringInput
	{
		...
		URangedWeaponInstance* WeaponData = nullptr;
