...
#include "DamageLogDebuggerComponent.generated.h"
...
class UDamageLogDebuggerComponent : public UActorComponent
{
	GENERATED_BODY()

public:

	UDamageLogDebuggerComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
