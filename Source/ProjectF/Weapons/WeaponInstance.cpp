	...
	: Super(ObjectInitializer)
{
	...
	if (APawn* Pawn = GetPawn())
	{
		...
		{
			// TODO: UHealthComponent
			// if (UHealthComponent* HealthComponent = UHealthComponent::FindHealthComponent(GetPawn()))
			// {
...
{
	const FBaseAnimLayerSelectionSet& SetToQuery = (bEquipped ? EquippedAnimSet : UneuippedAnimSet);
