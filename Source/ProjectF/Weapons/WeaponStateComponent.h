...
UCLASS()
class UWeaponStateComponent : public UControllerComponent
{
	GENERATED_BODY()
...
public:
	...
	void GetLastWeaponDamageScreenLocations(TArray<FScreenSpaceHitLocation>& WeaponDamageScreenLocations)
	{
