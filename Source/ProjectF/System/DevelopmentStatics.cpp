...
// TODO: UBaseDeveloperSettings
// #include "Development/BaseDeveloperSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(DevelopmentStatics)

bool UDevelopmentStatics::ShouldSkipDirectlyToGameplay()
{
#if WITH_EDITOR
	// TODO: UBaseDeveloperSettings
	// if (GIsEditor)
	// {
	// 	return !GetDefault<UBaseDeveloperSettings>()->bTestFullGameFlowInPIE;
	// }
#endif
	return false;
}

bool UDevelopmentStatics::ShouldLoadCosmeticBackgrounds()
{
#if WITH_EDITOR
	// TODO: UBaseDeveloperSettings
	// if (GIsEditor)
	// {
	// 	return !GetDefault<UBaseDeveloperSettings>()->bSkipLoadingCosmeticBackgroundsInPIE;
	// }
#endif
	return true;
}

bool UDevelopmentStatics::CanPlayerBotsAttack()
{
#if WITH_EDITOR
	// TODO: UBaseDeveloperSettings
	// if (GIsEditor)
	// {
	// 	return GetDefault<UBaseDeveloperSettings>()->bAllowPlayerBotsToAttack;
	// }
#endif
	return true;
}
...
UWorld* UDevelopmentStatics::FindPlayInEditorAuthorityWorld()
{
	check(GEngine);
...
TArray<FAssetData> UDevelopmentStatics::GetAllBlueprints()
{
...
UClass* UDevelopmentStatics::FindBlueprintClass(const FString& TargetNameRaw, UClass* DesiredBaseClass)
{
	FString TargetName = TargetNameRaw;
	TargetName.RemoveFromEnd(TEXT("_C"), ESearchCase::CaseSensitive);

	TArray<FAssetData> BlueprintList = UDevelopmentStatics::GetAllBlueprints();
...
UClass* UDevelopmentStatics::FindClassByShortName(const FString& SearchToken, UClass* DesiredBaseClass, bool bLogFailures)
{
